class CfgWeapons
{
    ...
    {
        picture=QICON(VSM_AOR1_BDU_OD_pants_Uniform.paa);
    };

    class VSM_AOR1_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_BDU_tan_pants_Uniform.paa);
    };

    class VSM_AOR1_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_BDU_Uniform.paa);
    };

    class VSM_AOR1_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Casual_uniform.paa);
    };

    class VSM_AOR1_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_grey_pants_Uniform.paa);
    };

    class VSM_AOR1_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_AOR1_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_od_pants_Uniform.paa);
    };

    class VSM_AOR1_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_od_shirt_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_AOR1_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_SS_tan_shirt_Uniform.paa);
    };
    ...
    {
        picture=QICON(VSM_AOR1_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_AOR1_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_Tee_Uniform.paa);
    };

    class VSM_AOR1_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Crye_Uniform.paa);
    };

    class VSM_AOR1_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_od_pants_Uniform.paa);
    };

    class VSM_AOR1_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_AOR1_od_pants_Uniform_SS.paa);
    };

    class VSM_AOR1_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_od_shirt_Uniform.paa);
    };

    class VSM_AOR1_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_AOR1_od_shirt_Uniform_SS.paa);
    };

    class VSM_AOR1_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_tan_pants_Uniform.paa);
    };

    class VSM_AOR1_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_AOR1_tan_pants_Uniform_SS.paa);
    };

    class VSM_AOR1_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_tan_shirt_Uniform.paa);
    };

    class VSM_AOR1_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_AOR1_tan_shirt_Uniform_SS.paa);
    };

    class VSM_AOR1_Camo : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Uniform.paa);
    };

    class VSM_AOR1_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Uniform_SS.paa);
    };

    class VSM_AOR1_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_AOR1_Uniform_TShirt.paa);
    };

    class VSM_CSAT_AOR2_Camo : Uniform_Base
    {
        picture=QICON(VSM_CSAT_AOR2_Uniform.paa);
    };

    class VSM_CSAT_MulticamTropic_Camo : Uniform_Base
    {
        picture=QICON(VSM_CSAT_MulticamTropic_Uniform.paa);
    };

    class VSM_M81_BDU_OD_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_BDU_OD_pants_Uniform.paa);
    };

    class VSM_M81_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_BDU_tan_pants_Uniform.paa);
    };

    class VSM_M81_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_BDU_Uniform.paa);
    };

    class VSM_M81_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Casual_uniform.paa);
    };

    class VSM_M81_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_grey_pants_Uniform.paa);
    };

    class VSM_M81_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_od_pants_Uniform.paa);
    };

    class VSM_M81_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_od_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_M81_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_M81_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_M81_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_SS_Uniform.paa);
    };

    class VSM_M81_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_tan_pants_Uniform.paa);
    };

    class VSM_M81_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_M81_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_Tee_Uniform.paa);
    };

    class VSM_M81_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Crye_Uniform.paa);
    };

    class VSM_M81_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_od_pants_Uniform.paa);
    };

    class VSM_M81_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_M81_od_pants_Uniform_SS.paa);
    };

    class VSM_M81_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_od_shirt_Uniform.paa);
    };

    class VSM_M81_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_M81_od_shirt_Uniform_SS.paa);
    };

    class VSM_M81_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_tan_pants_Uniform.paa);
    };

    class VSM_M81_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_M81_tan_pants_Uniform_SS.paa);
    };

    class VSM_M81_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_tan_shirt_Uniform.paa);
    };

    class VSM_M81_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_M81_tan_shirt_Uniform_SS.paa);
    };

    class VSM_M81_Camo : Uniform_Base
    {
        picture=QICON(VSM_M81_Uniform.paa);
    };

    class VSM_M81_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_M81_Uniform_SS.paa);
    };

    class VSM_M81_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_M81_Uniform_TShirt.paa);
    };

    class VSM_MulticamTropic_BDU_OD_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_BDU_OD_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_BDU_tan_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_BDU_Uniform.paa);
    };

    class VSM_MulticamTropic_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Casual_uniform.paa);
    };

    class VSM_MulticamTropic_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_grey_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_od_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_od_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_SS_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_tan_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_Tee_Uniform.paa);
    };

    class VSM_MulticamTropic_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Crye_Uniform.paa);
    };

    class VSM_MulticamTropic_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_od_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_od_pants_Uniform_SS.paa);
    };

    class VSM_MulticamTropic_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_od_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_od_shirt_Uniform_SS.paa);
    };

    class VSM_MulticamTropic_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_tan_pants_Uniform.paa);
    };

    class VSM_MulticamTropic_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_tan_pants_Uniform_SS.paa);
    };

    class VSM_MulticamTropic_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_tan_shirt_Uniform.paa);
    };

    class VSM_MulticamTropic_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_tan_shirt_Uniform_SS.paa);
    };

    class VSM_MulticamTropic_Camo : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Uniform.paa);
    };

    class VSM_MulticamTropic_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Uniform_SS.paa);
    };

    class VSM_MulticamTropic_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_MulticamTropic_Uniform_TShirt.paa);
    };

    class VSM_Multicam_BDU_OD_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_BDU_OD_pants_Uniform.paa);
    };

    class VSM_Multicam_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_BDU_tan_pants_Uniform.paa);
    };

    class VSM_Multicam_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_BDU_Uniform.paa);
    };

    class VSM_Multicam_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Casual_uniform.paa);
    };

    class VSM_Multicam_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_grey_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_od_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_od_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_SS_Uniform.paa);
    };

    class VSM_Multicam_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_tan_pants_Uniform.paa);
    };

    class VSM_Multicam_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_Multicam_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_Tee_Uniform.paa);
    };

    class VSM_Multicam_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Crye_Uniform.paa);
    };

    class VSM_Multicam_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_od_pants_Uniform.paa);
    };

    class VSM_Multicam_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_Multicam_od_pants_Uniform_SS.paa);
    };

    class VSM_Multicam_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_od_shirt_Uniform.paa);
    };

    class VSM_Multicam_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_Multicam_od_shirt_Uniform_SS.paa);
    };

    class VSM_Multicam_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_tan_pants_Uniform.paa);
    };

    class VSM_Multicam_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_Multicam_tan_pants_Uniform_SS.paa);
    };

    class VSM_Multicam_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_tan_shirt_Uniform.paa);
    };

    class VSM_Multicam_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_Multicam_tan_shirt_Uniform_SS.paa);
    };

    class VSM_Multicam_Camo : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Uniform.paa);
    };

    class VSM_Multicam_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Uniform_SS.paa);
    };

    class VSM_Multicam_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_Multicam_Uniform_TShirt.paa);
    };

    class VSM_OCP_BDU_OD_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_BDU_OD_pants_Uniform.paa);
    };

    class VSM_OCP_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_BDU_tan_pants_Uniform.paa);
    };

    class VSM_OCP_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_BDU_Uniform.paa);
    };

    class VSM_OCP_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Casual_uniform.paa);
    };

    class VSM_OCP_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_grey_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_od_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_od_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_SS_Uniform.paa);
    };

    class VSM_OCP_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_tan_pants_Uniform.paa);
    };

    class VSM_OCP_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_OCP_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_Tee_Uniform.paa);
    };

    class VSM_OCP_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Crye_Uniform.paa);
    };

    class VSM_OCP_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_od_pants_Uniform.paa);
    };

    class VSM_OCP_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OCP_od_pants_Uniform_SS.paa);
    };

    class VSM_OCP_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_od_shirt_Uniform.paa);
    };

    class VSM_OCP_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OCP_od_shirt_Uniform_SS.paa);
    };

    class VSM_OCP_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_tan_pants_Uniform.paa);
    };

    class VSM_OCP_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OCP_tan_pants_Uniform_SS.paa);
    };

    class VSM_OCP_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_tan_shirt_Uniform.paa);
    };

    class VSM_OCP_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OCP_tan_shirt_Uniform_SS.paa);
    };

    class VSM_OCP_Camo : Uniform_Base
    {
        picture=QICON(VSM_OCP_Uniform.paa);
    };

    class VSM_OCP_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OCP_Uniform_SS.paa);
    };

    class VSM_OCP_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_OCP_Uniform_TShirt.paa);
    };

    class VSM_OGA_Crye_grey_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_grey_od_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_grey_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_grey_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_grey_tan_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_grey_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_grey_Uniform.paa);
    };

    class VSM_OGA_Crye_od_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_od_grey_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_od_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_od_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_od_tan_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_od_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_od_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_grey_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_grey_od_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_grey_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_grey_tan_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_grey_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_grey_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_od_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_od_grey_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_od_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_od_tan_pants_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_od_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_od_Uniform.paa);
    };

    class VSM_OGA_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_SS_Uniform.paa);
    };

    class VSM_OGA_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Crye_Uniform.paa);
    };

    class VSM_OGA_grey_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_grey_Casual_uniform.paa);
    };

    class VSM_OGA_OD_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_OD_Casual_uniform.paa);
    };

    class VSM_OGA_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_pants_Uniform.paa);
    };

    class VSM_OGA_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_pants_Uniform_SS.paa);
    };

    class VSM_OGA_od_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_tan_pants_Uniform.paa);
    };

    class VSM_OGA_od_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_tan_pants_Uniform_SS.paa);
    };

    class VSM_OGA_od_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_Uniform.paa);
    };

    class VSM_OGA_od_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OGA_od_Uniform_SS.paa);
    };

    class VSM_OGA_tan_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_tan_Casual_uniform.paa);
    };

    class VSM_OGA_Camo : Uniform_Base
    {
        picture=QICON(VSM_OGA_Uniform.paa);
    };

    class VSM_OGA_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_OGA_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_BDU_OD_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_BDU_OD_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_BDU_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_BDU_tan_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_BDU_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_BDU_Uniform.paa);
    };

    class VSM_ProjectHonor_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Casual_uniform.paa);
    };

    class VSM_ProjectHonor_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_grey_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_od_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_od_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_SS_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_tan_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_Tee_Uniform.paa);
    };

    class VSM_ProjectHonor_Crye_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Crye_Uniform.paa);
    };

    class VSM_ProjectHonor_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_od_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_od_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_od_pants_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_od_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_od_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_od_shirt_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_tan_pants_Uniform.paa);
    };

    class VSM_ProjectHonor_tan_pants_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_tan_pants_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_tan_shirt_Uniform.paa);
    };

    class VSM_ProjectHonor_tan_shirt_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_tan_shirt_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_Camo : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Uniform.paa);
    };

    class VSM_ProjectHonor_Camo_SS : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Uniform_SS.paa);
    };

    class VSM_ProjectHonor_Camo_TShirt : Uniform_Base
    {
        picture=QICON(VSM_ProjectHonor_Uniform_TShirt.paa);
    };

    class VSM_Scorpion_Casual_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Casual_uniform.paa);
    };

    class VSM_Scorpion_Crye_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_grey_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_grey_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_od_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_od_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_grey_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_grey_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_grey_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_grey_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_od_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_od_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_od_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_od_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_tan_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_tan_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_SS_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_SS_Uniform.paa);
    };

    class VSM_Scorpion_Crye_tan_pants_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_tan_pants_Uniform.paa);
    };

    class VSM_Scorpion_Crye_tan_shirt_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_tan_shirt_Uniform.paa);
    };

    class VSM_Scorpion_Crye_Tee_Camo : Uniform_Base
    {
        picture=QICON(VSM_Scorpion_Crye_Tee_Uniform.paa);
    };
